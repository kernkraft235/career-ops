...
**Differences:** I will be modifying this to focus on normal jobs via LinkedIn and Indeed. I will also be swapping the harness to Codex or OpenCode since it's hard to pay for Claude when you have no job and were never making SWE money.
...
> [!NOTE]
> I will be removing these, to replace with normie job portals.
